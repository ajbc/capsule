...
This figure shows that Capsule detects many of the well-known events
between 1973 and 1978, including the fall of Saigon (April 30, 1975) and the death of Mao Tse-tung (September 9, 1976). 
Capsule uncovers obscure but significant events that have largely escaped 
the attention of scholars, such as when the U.S.~defended its 
control of the Panama Canal before the U.N.~Security Council (March 19, 1973).
...
Broadly speaking, Capsule provides a way to detect and
characterize historical moments that might be of interest to
historians, political scientists, and journalists.

% Hanna: I re-capitalized ``Embassies'' because when the content
% following a colon consists of multiple sentences, as is the case
% here, there should be a capital letter.
...
% Hanna: I prefer having this as a stand-alone section
