...
\caption{Measure of time interval impact on cable content (Eq.~\ref{eq:eventness}).  The grey background indicates the number of cables sent over time.}
...
(Jun 27--July 4, 1976), and the fall of Saigon (April 30, 1975). It also identifies other moments,
