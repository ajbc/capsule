...
The model we have presented fits each entity independently. In this scenario, modeling ``business-as-usual'' topics is more challenging for entities with sparser sending patterns.
Moving forward, modeling multiple entities interacting with each other about the same topics should make inference easier in this regard, though more complicated overall.  We also plan to include geographic proximity, which should have a similar effect.
