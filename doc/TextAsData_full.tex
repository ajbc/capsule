...
\PP describe, at a high level, what we want to be able to find (kind of a repeat of things discussed before)

\PP highlight some ``business-as-usual'' topics.  Just say what they are for what entities...maybe in a table or figure?

\PP highlight some events (specifically the fall of Saigon, if the model finds it).  Point out when they occur (and how it matches truth), but also what they are about (topic dist)
