...
%TODO finish this eqn (not done putting M in....
\begin{align}
...
%TODO: break equations down above, and then refer to en number in the algorithm below.
\alglanguage{pseudocode}
\begin{algorithm}[h]
\small
...
\Repeat
	...
	\For {$s=1, \dots, S$}
		...
		\For {$j=1, \dots, B$ (batch size, or \# of document samples)}
			...
			\EndFor
			%TODO: epsilon and softmax beyond htis point.....
